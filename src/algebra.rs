...
pub fn naive_gcd(a: i64, b: i64) -> i64 {
    if b == 0 {
        a
    } else {
        naive_gcd(b, a % b)
...
pub fn extended_gcd(args: GCDArgs) -> GCDRes {
    if args.b == 0 {
...
pub fn binary_addition(A: Vec<usize>, B: Vec<usize>) -> Vec<usize> {
...
pub fn sieve_of_eratosthenes(x: u64) -> Vec<bool> {
